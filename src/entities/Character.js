...
export class Character {
  ...
  _build() {
    ...
    this.head = this.scene.add.container(0, -58);
    ...
    this.face.fillCircle(-4, -3, 1.6);
    this.face.fillCircle(4, -3, 1.6);
    this.face.lineStyle(1.5, 0x2a2438, 1);
    this.face.beginPath();
    this.face.arc(0, 1, 3.4, Phaser.Math.DegToRad(20), Phaser.Math.DegToRad(160));
    this.face.strokePath();
    this.face.fillStyle(0xff9e9e, 0.4);
    this.face.fillCircle(-6, 1, 2);
    this.face.fillCircle(6, 1, 2);
    ...
    this.backHair.fillCircle(0, -4, 11);
  ...
  update(vx, vy, dt) {
    ...
    if (this.moving) {
      ...
      this.head.y = -58 + Math.sin(this.scene.time.now / 600) * 0.6;
    }
  }
}
